  ...
  <div class="page-container">
    ...
    <div class="sign sign-up">
      <div class="sign-container signup-container">
        <div class="sign-head">
          <span class="left-align">用户注册</span>
        </div>
        <el-form ref="signUpForm" label-width="70px" status-icon :model="registerForm" :rules="SignUpRules" class="standard-form signup-form">
          ...
          <el-form-item prop="birth" label="生日">
            <el-date-picker type="date" placeholder="选择日期" v-model="registerForm.birth" style="width: 100%" class="date-picker-no-icon"></el-date-picker>
          </el-form-item>
          ...
          <el-form-item class="sign-btn">
            <el-button @click="goBackRegist()" class="secondary-btn">取消</el-button>
            <el-button type="primary" @click="handleSignUp" class="primary-btn">确定</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
